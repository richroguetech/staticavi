...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--driving_video", default="driving.mp4", help="path to driving video"
    )
    ...
    if opt.audio:
        try:
            ...
            print(
                "Failed to copy audio: the driving video may have no audio track or the audio format is invalid."
            )
